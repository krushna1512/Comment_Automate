...
def comment_on_inactive_issues():
    ...
    for issue in issues:
        ...
        if not last_comment or last_comment.created_at < current_date:
            ...
            assignee_mentions = " @" + " @".join(assignee_names)
            
            comment = f"Hello{assignee_mentions}! It seems no activity has been recorded on this issue for the past 4 days. Is there anything I can assist you with?"
